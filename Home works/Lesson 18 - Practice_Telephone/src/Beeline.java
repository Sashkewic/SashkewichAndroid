public class Beeline extends Telephone{
    ...
    private double internetCost; // стоимость 1 ГБ интернет-трафика
    ...
    public void callTo(String phoneNumber, double countMinutes){ // метод, позволяющий звонить на чей-то номер
        ...
        if (phoneNumber.startsWith("070") || phoneNumber.startsWith("055")){ // если номер телефона начинается на 070 или 055,
            setCallCost(1);
        ...
        else { // если номер телефона начинается на 077, то есть номер телефона принадлежит Beeline
            setCallCost(0);
            System.out.printf("Вы позвонили на номер: %s. Это номер принадлежит оператору Beeline. \n" +
                            "Звонок длился %.1f минут(ы) \n" +
    ...
    public void sendSms(String phoneNumber, String text){ // метод, позволяющий отправлять СМС-сообщения на чей-то номер
        ...
        if (phoneNumber.startsWith("070") || phoneNumber.startsWith("055")){ // если номер телефона начинается на 077 или 055,
            setSmsCost(2);
            ...
            setSmsCost(0);
            System.out.printf("Вы написали СМС-сообщение на номер: %s. СМС-сообщение отправлено на номер Beeline." + "\n" +
                    "Его содержание: %s" + "\n" +
